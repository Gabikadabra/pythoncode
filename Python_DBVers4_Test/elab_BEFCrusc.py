...
from read_forn import df_forn_byCod 
...
df_BEF_Forn_grp=pd.merge(df_BEF_Forn_grp,df_BDO[["ROI","BDO","ROI_dip","StatoBDO","Contratto Gara","DEC","RUP","Fornitore RTI","Numero Contratto Gara","RDI"]],left_on="BDO", right_on="BDO",how="left",suffixes=('', '_fBDO'))
