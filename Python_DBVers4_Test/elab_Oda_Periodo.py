...
df_ODA=df_ODALin.groupby(["Doc. acq.","Numero CIG", "ROI","ROI_dip", "ROI_cod", "InizVal.", "FineVal.",  "Forn_main","Forn_nome", "RDI", "Testo testata BDO", "StartDate","Tipo","Stato","Stato_cod","DEC","Descrizione_DEC"]).agg(Tot_ODA=("Valore netto","sum"),Tot_MAP=("ValoreCons","sum"),ROI_CdC=("ROI_CdC","first")).reset_index()
