#Not filteered list
# read_verbAtt_v6 timuove i filtri rispetto ai rilasci chiusi, che vengono ora impiegati
# #New Reportistica ---
...
#rev 20250930 wRil_Status = ['Chiusura Amministrativa', 'Concluso', 'Sospeso','Annullato']
#rev 20250930 df_Rilasci_cln=df_Rilasci_cln.loc[~df_Rilasci_cln["Stato Incarico"].isin(wRil_Status)]

#rev 20250930 df_Rilasci_cln["INCARICO"]=df_Rilasci_cln["INCARICO"].str.strip() #clean blanks 


#filter Rilasci not "Giunta"
#rev 20250930 df_Rilasci_cln=df_Rilasci_cln.loc[df_Rilasci_cln["Codice Cliente"].str.contains("5000039", na=False)]

#rev 20250930 wIncarichi_cln_list=df_Rilasci_cln["INCARICO"].unique()
...
df_elab_Rilasci=df_RilInc
#rev 20250930 df_elab_Rilasci=df_RilInc.loc[df_RilInc["cod incarico"].isin(wIncarichi_list_act)]#(wIncarichi_cln_list)]
#rev 20250930 wRilasci_cln_list=df_elab_Rilasci["Cod Rilascio"].unique()
...
df_elab_Incarichi=df_Incarichi
#rev 20250930 df_elab_Incarichifull=df_Incarichi
#rev 20250930 df_elab_Incarichi=df_Incarichi.loc[df_Incarichi["cod incarico"].isin(wIncarichi_list_act)]
...
#rev 20250930 df_RefInc_cln=df_RefInc.loc[df_RefInc["cod incarico"].isin(wIncarichi_list_act)]
df_RefInc_cln=df_RefInc.loc[(df_RefInc["Ruolo"]!="DAFC")] #&(df_RefInc["Ordine approvazione"]!=2)
...
df_elab_RilPPA=df_RilasciPPA 
#20250930rev df_elab_RilPPA=df_RilasciPPA.loc[df_RilasciPPA["Codice Rilascio"].isin(wRilasci_cln_list)]
...
#20250930 df_RCA_RefRL=df_RCA_RefRL.loc[df_RCA_RefRL["cod incarico"].isin(wIncarichi_list_act)]
...
#20250930 df_elab_Imp_Spalm=df_elab_Imp_Spalm.loc[df_elab_Imp_Spalm["cod rilascio"].isin(wRilasci_cln_list)]
...
#20250930 df_elab_RefRil=df_elab_RefRil.loc[(df_elab_RefRil["cod incarico"].isin(wIncarichi_cln_list))&(df_elab_RefRil["Ruolo"].isin(wSelRuolo))]
df_elab_RefRil=df_elab_RefRil.loc[(df_elab_RefRil["Ruolo"].isin(wSelRuolo))]
